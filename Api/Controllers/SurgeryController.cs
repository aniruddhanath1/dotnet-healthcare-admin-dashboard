...
namespace dotnet_admin_dashboard.Api.Controllers
{
    ...
    public class SurgeryController : ControllerBase
    {
        ...
        [HttpPost("dto")]
        public async Task<IActionResult> CreateDto([FromBody] SurgeryDto dto)
        {
            await _service.AddAsync(dto);
            return CreatedAtAction(nameof(GetDto), new { id = dto.Id }, dto);
        }
        [HttpPut("dto/{id}")]
        public async Task<IActionResult> UpdateDto(int id, [FromBody] SurgeryDto dto)
        {
            dto.Id = id;
        ...
        [HttpPost("mongo")]
        public async Task<IActionResult> AddMongo([FromBody] Surgery entity)
        {
            await _service.AddMongoAsync(entity);
            return CreatedAtAction(nameof(GetByIdMongo), new { id = entity.Id }, entity);
        }
        [HttpPut("mongo/{id}")]
        public async Task<IActionResult> UpdateMongo(string id, [FromBody] Surgery entity)
        {
            entity.Id = id;
