...
namespace dotnet.Api.Controllers
{
    ...
    public class RoomController : ControllerBase
    {
        ...
        [HttpPost("dto")]
        public async Task<IActionResult> CreateDto([FromBody] RoomDto dto)
        {
            await _service.AddAsync(dto);
            return CreatedAtAction(nameof(GetDto), new { id = dto.Id }, dto);
        }
        [HttpPut("dto/{id}")]
        public async Task<IActionResult> UpdateDto(int id, [FromBody] RoomDto dto)
        {
            dto.Id = id;
        ...
        [HttpPost("mongo")]
        public async Task<IActionResult> AddMongo([FromBody] Room entity)
        {
            await _service.AddMongoAsync(entity);
            return CreatedAtAction(nameof(GetByIdMongo), new { id = entity.Id }, entity);
        }
        [HttpPut("mongo/{id}")]
        public async Task<IActionResult> UpdateMongo(string id, [FromBody] Room entity)
        {
            entity.Id = id;
